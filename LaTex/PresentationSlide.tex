...
\begin{figure}[h]
    \centering
    \safeincludegraphics[width=\linewidth]{../output/8yrs_1SE_base_rf_ridge_bias_variance.png}
...
\begin{figure}[h]
    \centering
    \safeincludegraphics[width=\linewidth]{../output/8yrs_base_rf_train_test.png}
...
\begin{frame}[t]{Experiment with hourly data}
\tiny
