...
\begin{itemize}
    ...
    \item Parameters. For stat models: selected by 1SE rule. For PCA: best CV metric 
    \item Evaluation metrics:
    \begin{itemize}
      \item Balanced accuracy in parameter tunning (reduced degenerated one)
      \item Mainly Test accuracy for model comparison
      \item Other metrics: ROC-AUC, Specificity, Sensitivity (recall)
    \end{itemize}
\end{itemize}
\end{block}
...
\begin{itemize}
  ...
  \item Best test accuracy: Baseline (noregularization)+ PCA (197 comps), Test Acc = 0.5572
