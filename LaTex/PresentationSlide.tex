...
% Make table environment non-floating inside Beamer frames
...
\begin{figure}[h]
    \centering
    \safeincludegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{../output/8yrs_base_rf_best_tree.png}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../output/8yrs_base_rf_best_model_bias_variance.png}
  \caption{Bias-Variance Tradeoff: max_depth}
  \label{fig:bv-overall}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../output/8yrs_base_rf_best_model_bias_variance_classifier_max_features.png}
  \caption{Bias-Variance Tradeoff: \texttt{max\_features}}
  \label{fig:bv-maxfeatures}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../output/8yrs_base_rf_best_model_bias_variance_classifier_n_estimators.png}
  \caption{Bias-Variance Tradeoff: \texttt{n\_estimators}}
  \label{fig:bv-nestimators}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../output/8yrs_base_rf_best_model_train_test.png}
  \caption{Over/Underfitting: max_depth}
  \label{fig:ov-overall}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../output/8yrs_base_rf_best_model_train_test_classifier_max_features.png}
  \caption{Over/Underfitting: \texttt{max\_features}}
  \label{fig:ov-maxfeatures}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../output/8yrs_base_rf_best_model_train_test_classifier_n_estimators.png}
  \caption{Over/Underfitting: \texttt{n\_estimators}}
  \label{fig:ov-nestimators}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{../output/8yrs_family_leaders_accuracy_vs_cv_sd.png}
...
\begin{figure}[htbp]
  \centering
\safeincludegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{../output/8yrs_family_leaders_cv_accuracy_vs_cv_sd.png}
...
\begin{figure}[htbp]
  \centering
  \safeincludegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../output/8yrs_prediction_distribution_base_random_forest_py_rf_dow.png}
