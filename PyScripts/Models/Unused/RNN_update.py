#!/usr/bin/env python3
"""
RNN update using engineered features from H_prep.clean_data
...
def main():
    parser = argparse.ArgumentParser(description="RNN update with optional engineered features.")
    parser.add_argument(
