#!/usr/bin/env python3
"""RNN update aligned with the raw baseline data-loading pipeline."""
...
def reshape_for_rnn(X, sequence_length=7):
...
def main():
    print("=" * 70)
    print("RNN UPDATE: RAW BASELINE-STYLE FEATURES")
    print("=" * 70)
    ...
    output_path = output_dir / "8yrs_rnn_update_raw_result.txt"
    with open(output_path, "w") as f:
        f.write("=" * 70 + "\n")
        f.write("RNN UPDATE RESULTS - RAW BASELINE-STYLE FEATURES\n")
        f.write("=" * 70 + "\n\n")
