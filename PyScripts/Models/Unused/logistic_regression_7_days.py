...
def main():
    ...
    plt.tight_layout()
    plt.savefig(output_dir / '8yrs_logistic_regression_7days_confusion_matrix.png', dpi=150, bbox_inches='tight')
    plt.close()

    # Save results to text file
    with open(output_dir / "8yrs_logistic_regression_7days_results.txt", 'w') as f:
        f.write("=" * 70 + "\n")
    ...
    print(f"✓ Saved confusion matrix plot: {output_dir / '8yrs_logistic_regression_7days_confusion_matrix.png'}")
    print(f"✓ Saved results to: {output_dir / '8yrs_logistic_regression_7days_results.txt'}\n")
    ...
    plt.xlabel('Predicted')
    plt.tight_layout()
    plt.savefig(output_dir / '8yrs_logistic_regression_7days_l1_confusion_matrix.png', dpi=150, bbox_inches='tight')
    plt.close()

    # Save L1 results
    with open(output_dir / "8yrs_logistic_regression_7days_l1_results.txt", 'w') as f:
        f.write("=" * 70 + "\n")
    ...
    print(f"✓ Saved L1 confusion matrix plot: {output_dir / '8yrs_logistic_regression_7days_l1_confusion_matrix.png'}")
    print(f"✓ Saved L1 results to: {output_dir / '8yrs_logistic_regression_7days_l1_results.txt'}\n")
    ...
    # Save comparison
    with open(output_dir / "8yrs_logistic_regression_7days_comparison.txt", 'w') as f:
        f.write("=" * 70 + "\n")
    ...
    print(f"\n✓ Saved comparison to: {output_dir / '8yrs_logistic_regression_7days_comparison.txt'}\n")
